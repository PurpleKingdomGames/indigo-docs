...
There is a brief introduction to using shaders in your project as part of the ["how to create a custom entity"](/documentation/02-guides/howto-custom-entity.md) guide that we recommend you read first, which also has an accompanying [example repo](https://github.com/PurpleKingdomGames/indigo-examples/tree/master/howto/custom-entity).

There is a follow on tutorial to the one above than explains [how to make a fire shader](/documentation/02-guides/howto-fire-shader.md) that you may also find useful.
...
Custom shaders are generally expected to be used in conjunction with custom entities, please see the [guide](/documentation/02-guides/howto-custom-entity.md) for examples.
...
In the [guide](/documentation/02-guides/howto-custom-entity.md), we create a custom entity that fills it's self with a solid color:
