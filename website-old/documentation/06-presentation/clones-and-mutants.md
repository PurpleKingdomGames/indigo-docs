...
The idea here is that you have [created a custom entity](/documentation/02-guides/howto-custom-entity.md) and for each instance, you want to set it's UBO data, which here contains a position, a scale and an alpha value.
...
The fragment shader takes the default texture channel and applies the supplied alpha to it. Note the use of [premultiplied alpha](/documentation/07-shaders/premultiplied-alpha.md).
