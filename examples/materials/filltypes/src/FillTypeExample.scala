...
object FillTypeExample extends IndigoSandbox[Unit, Unit]:
  ...
  def present(context: Context[Unit], model: Unit): Outcome[SceneUpdateFragment] =
    Outcome(
      SceneUpdateFragment(
        Graphic(0, 0, 128, 128, 1, material.normal).moveTo(0, 0),
        Graphic(0, 0, 128, 128, 1, material.tile).moveTo(128, 0),
        Graphic(0, 0, 128, 128, 1, material.stretch).moveTo(0, 128),
        Graphic(0, 0, 128, 128, 1, material.nineSlice(16, 16, 32, 32)).moveTo(128, 128),
