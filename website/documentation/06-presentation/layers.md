...
You can read more about this subject in the [blending section of the docs](/documentation/07-shaders/blending.md), but in a nutshell a `Blending` instance is comprised of two things:
